            ...
            <tr>
                ...
                <td>
                     <form className="search-bar" onSubmit={searchByKeyword}>
                        ...
                        />
                        <button type="submit">
                            <svg id="search-logo" xmlns="http://www.w3.org/2000/svg" width="17" height="57" fill="#333;" className="bi bi-search" viewBox="0 0 16 18"> 
                ...
                <td></td>
                <td align="right" style={{marginRight: '10px'}} className="right-menu">
